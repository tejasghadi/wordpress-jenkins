...
function neatly_breadcrumb_list(){
	...
	$delimiter        = '&nbsp;&raquo;&nbsp;';/* Delimiter between crumbs' &raquo; '*/
	...
	$breadcrumb_output_link = '<nav class="post_item mb_L"><ol id="breadcrumb" class="breadcrumb f_box f_wrap ai_c">'.$breadcrumb_output_link.'</ol></nav><!-- .breadcrumbs -->';
